...
flownet2sd = FlowNet2SD(color_range=[-1., 1.])
...
axs[0].imshow(frame_t.astype('uint8').transpose(1, 2, 0))
axs[0].set_title('frame_t')
axs[1].imshow(frame_tp.astype('uint8').transpose(1, 2, 0))
