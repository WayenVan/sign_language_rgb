...
def assert_variable_is_tuple_of_dicts(variable):
    assert isinstance(variable, tuple), "Variable is not a tuple"
    assert all(isinstance(item, dict) for item in variable), "Not all elements in the tuple are dictionaries"
...
class SpatialWeighting(nn.Module):
    ...
    def __init__(self,
        ...
        assert_variable_is_tuple_of_dicts(act_cfg)
...
class IterativeHeadDownSample(nn.Module):
