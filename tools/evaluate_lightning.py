...
@click.option(
    "--config", "-c", default="outputs/train_lightning/2024-05-11_16-19-53/config.yaml"
)
@click.option(
    "-ckpt",
    "--checkpoint",
    default="outputs/train_lightning/2024-05-11_16-19-53/epoch=48_wer-val=22.79_lr=0.00e+00_loss=0.00.ckpt",
)
...
def main(config, checkpoint, ph14_root, ph14_lmdb_root, tmp, mode):
    ...
    model = SLRModel.load_from_checkpoint(
        checkpoint, cfg=cfg, map_location="cpu", ctc_search_type="greedy", strict=False
    )
